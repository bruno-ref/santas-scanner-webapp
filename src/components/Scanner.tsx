...
const Scanner: React.FC = () => {
  ...
  const fetchQuestions = async () => {
    const res = await axios.get('https://santas-scanner-backend-eight.vercel.app/questions');
  ...
  const calculateResult = async () => {
    ...
    try {
      const res = await axios.post('https://santas-scanner-backend-eight.vercel.app/scan-results', verdict);
